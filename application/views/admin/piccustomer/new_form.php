			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/piccustomer/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">
					<form action="<?php base_url('admin/piccustomer/add') ?>" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('namapic') ? 'is-invalid':'' ?>"
								 type="text" name="namapic" placeholder="Nama PIC" />
								<div class="invalid-feedback">
