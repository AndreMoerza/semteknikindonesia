...
<body id="page-top">
			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
						...
						<form action="<?php base_url('admin/purchaseorder/add') ?>" method="post" enctype="multipart/form-data" >
							<div class="row">
								<div class="form-group col-lg-6">
									...
									type="text" name="nopo" id="nopo" placeholder="No PO"  value="<?php echo $po->nopo ?>" disabled/>
								...
								<div class="form-group col-lg-6">
									...
									type="text" name="tanggalpo" id="tanggalpo" value="<?php echo $po->tanggalpo ?>" placeholder="Tanggal PO" id="tanggalpo" readonly/>
									<div class="invalid-feedback">
							...
							<div class="row">
								<div class="form-group col-lg-6">
									...
									<input type="hidden" name="idcust" id="idcust" value="<?php echo $po->idcust ?>" />
									<input class="form-control <?php echo form_error('idcust') ? 'is-invalid':'' ?>"
									type="text" name="customer" id="customer" placeholder="Customer" value="<?php echo $po->nama ?>"/>
								...
								<div class="form-group col-lg-6">
									...
									<?php foreach ($piccustomer as $rowpiccustomer): ?>
										<option value="<?php echo $rowpiccustomer->idpiccust;?>"
										<?php if ($rowpiccustomer->idpiccust == $po->idpiccust){ echo 'selected="selected"'; } ?>>
											<?php echo $rowpiccustomer->namapic;?>
										</option>
									<?php endforeach; ?>
									</select>
							...
							<div class="row">
								<div class="form-group col-lg-6">
									...
									<?php foreach ($marketing as $rowmarketing): ?>
										...
										<?php if ($rowmarketing->idmarketing == $po->idmarketing){ echo 'selected="selected"'; } ?>>
								...
								<div class="form-group col-lg-6">
									...
									type="text" name="potongan" id="potongan"  placeholder="Potongan" value="<?php echo $po->potongan ?>"/>
									<div class="invalid-feedback">
							...
							<div class="row">
								<div class="form-group col-lg-6">
									...
									type="text" name="ppn" id="ppn"  placeholder="PPN" value="<?php echo $po->ppn ?>"/>
									<div class="invalid-feedback">
								...
								<div class="form-group col-lg-6">
									...
									type="text" name="grandtotal" id="grandtotal" placeholder="Total" value="<?php echo $po->total ?>" disabled/>
									<div class="invalid-feedback">
					...
					<div class="card-footer small text-muted">
						<input class="btn btn-success" type="submit" name="btn" value="Update" onclick="simpanPO()"/>
					</div>
	...
	<script>
		...
		$(document).ready(function () {
				...
				$('#grandtotal').val(commaSeparateNumber($('#grandtotal').val()));
			...
			$.ajax({  
				...
				{  
					$.each(data, function( index, item ) {
						...
						var total = parseInt(item.quantity) * parseInt(item.harga);
						tambahBarang.push({
		...
		function getPICCustomerByCustId(CustId) {
			$.ajax({  
				...
				success:function(data)  
				{  
					$('#piccustomer').find('option').remove().end();
		...
		function simpanPO() {
			...
			grandtotal = removeCommaSeparateNumber(grandtotal);
